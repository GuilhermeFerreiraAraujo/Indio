    ...
    (function b(p, v, m) {
      ...
      5: [function(p, v, m) {
        ...
        function h(e, g, y, a) {
          ...
          if (!(g >= a)) {
            var c;
            y ? (g + 2 < a && (c = e[g + 2] << 16), g + 1 < a && (c |= e[g + 1] << 8), c |= e[g], g + 3 < a && (c += e[g + 3] << 24 >>> 0)) : (g + 1 < a && (c = e[g + 1] << 16), g + 2 < a && (c |= e[g + 2] << 8), g + 3 < a && (c |= e[g + 3]), c += e[g] << 24 >>> 0);
            return c;
          }
        }
        function d(e, g, a, c) {
          c || (q("boolean" === typeof a, "missing or invalid endian"), q(void 0 !== g && null !== g, "missing offset"), q(g + 1 < e.length, "Trying to read beyond buffer length"));
          if (!(g >= e.length))
            return e = k(e, g, a, !0), e & 32768 ? -1 * (65535 - e + 1) : e;
        }
        function a(e, g, a, c) {
          c || (q("boolean" === typeof a, "missing or invalid endian"), q(void 0 !== g && null !== g, "missing offset"), q(g + 3 < e.length, "Trying to read beyond buffer length"));
          if (!(g >= e.length))
            return e = h(e, g, a, !0), e & 2147483648 ? -1 * (4294967295 - e + 1) : e;
        }
        function l(e, g, a, c) {
          c || (q("boolean" === typeof a, "missing or invalid endian"), q(g + 3 < e.length, "Trying to read beyond buffer length"));
          return G.read(e, g, a, 23, 4);
        }
        function u(e, g, a, c) {
          c || (q("boolean" === typeof a, "missing or invalid endian"), q(g + 7 < e.length, "Trying to read beyond buffer length"));
          return G.read(e, g, a, 52, 8);
        }
        function r(e, g, a, c, b) {
          b || (q(void 0 !== g && null !== g, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 1 < e.length, "trying to write beyond buffer length"), H(g, 65535));
          var y = e.length;
          if (!(a >= y))
            for (b = 0, y = Math.min(y - a, 2); b < y; b++)
              e[a + b] = (g & 255 << 8 * (c ? b : 1 - b)) >>> 8 * (c ? b : 1 - b);
        }
        function t(e, g, a, c, b) {
          b || (q(void 0 !== g && null !== g, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < e.length, "trying to write beyond buffer length"), H(g, 4294967295));
          var y = e.length;
          if (!(a >= y))
            for (b = 0, y = Math.min(y - a, 4); b < y; b++)
              e[a + b] = g >>> 8 * (c ? b : 3 - b) & 255;
        }
        function z(e, g, a, c, b) {
          b || (q(void 0 !== g && null !== g, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 1 < e.length, "Trying to write beyond buffer length"), A(g, 32767, -32768));
          a >= e.length || (0 <= g ? r(e, g, a, c, b) : r(e, 65535 + g + 1, a, c, b));
        }
        function c(e, g, a, c, b) {
          b || (q(void 0 !== g && null !== g, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < e.length, "Trying to write beyond buffer length"), A(g, 2147483647, -2147483648));
          a >= e.length || (0 <= g ? t(e, g, a, c, b) : t(e, 4294967295 + g + 1, a, c, b));
        }
        function n(e, g, a, c, b) {
          b || (q(void 0 !== g && null !== g, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 3 < e.length, "Trying to write beyond buffer length"), D(g, 3.4028234663852886E38, -3.4028234663852886E38));
          a >= e.length || G.write(e, g, a, c, 23, 4);
        }
        function x(e, g, a, c, b) {
          b || (q(void 0 !== g && null !== g, "missing value"), q("boolean" === typeof c, "missing or invalid endian"), q(void 0 !== a && null !== a, "missing offset"), q(a + 7 < e.length, "Trying to write beyond buffer length"), D(g, 1.7976931348623157E308, -1.7976931348623157E308));
          a >= e.length || G.write(e, g, a, c, 52, 8);
        }
        function B(e, g, a) {
          if ("number" !== typeof e)
            return a;
        ...
        function L(e) {
          for (var g = [],
            ...
            if (127 >= c)
              ...
              var b = a;
              55296 <= c && 57343 >= c && a++;
              c = encodeURIComponent(e.slice(b, a + 1)).substr(1).split("%");
        ...
        function D(e, a, c) {
          ...
          q(e >= c, "value smaller than minimum allowed value");
        }
        function q(e, a) {
          if (!e)
      ...
      15: [function(p, v, m) {
        ...
        b.prototype.eachMapping = function(a, f, c) {
          ...
          c.map(function(a) {
            ...
            c = d.computeSourceURL(n, c, this._sourceMapURL);
            return {
              source: c,
      ...
      20: [function(p, v, m) {
        (function(b) {
          ...
          function r(b) {
            ...
            l && (l = a(l), b = u(b), b.getEvalOrigin = function() {
              return l;
            });
            return b;
          }
